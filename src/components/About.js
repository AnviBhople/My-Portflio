...
export default function About() {
	...
	const h1Style = {
		fontSize: "3rem",
		color: hover ? "#ffffff" : "black", // Changes color on hover
...
// export default function About() {
// 	// Custom styles for the boxes and text
// 	const boxStyle = {
// 		backgroundColor: "#adb5bd",
// 		padding: "2rem",
// 		borderRadius: "10%",
...
// 	const h1Style = {
// 		fontSize: "3rem",
// 		color: "#FF4500", // Orange Red to make the heading stand out
// 		textTransform: "uppercase",
...
// 					<h1
// 						style={h1Style}
// 						onMouseEnter={(e) => (e.target.style = h1HoverStyle)}
// 						onMouseLeave={(e) => (e.target.style = h1Style)}>
// 						About me
// 					</h1>
// 					<h5>
// 						I'm Anvi, a passionate front-end developer with a love for creating
...
// 				<div style={boxStyle}>
// 					<p style={textStyle}>
// 						● Who is Anvi? <br /> A passionate front-end developer from India.{" "}
// 						<br />
// 						<br /> ● What are her skills? <br /> She uses React.js, Bootstrap,
// 						Tailwind CSS, HTML5, CSS3, and JavaScript to create visually
// 						appealing websites. <br />
...
// 						<br /> ● What drives her? <br /> A love for coding and a desire to
// 						push the boundaries of what's possible in web development. <br />
// 						<br /> ● What are her interests? <br /> She tries to drive progress
// 						by learning new technologies, experimenting with new tools, and
// 						brainstorming ideas for future projects.
// 					</p>
// 				</div>
// 			</div>

// 			<footer className="footer mt-auto py-3 bg-secondary text-center">
// 				<h3 className="footer-content">
// 					With ❤️ from &ensp;
// 					<a href="/" className="async" style={Async}>
// 						Anvi
